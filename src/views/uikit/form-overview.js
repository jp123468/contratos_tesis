                        ...
                        <Tab.Content>
                            <Tab.Pane eventKey="first" className={toggleState === true ? "content  active-content" : "content"} id="content-form-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example">
                                    <form>
                                        <div className="mb-3">
                                            <h3 htmlFor="exampleInputEmail1" className="">Email address</h3>
                                        ...
                                        <div className="mb-3">
                                            <h3 htmlFor="exampleInputPassword1" className="">Password</h3>
                                        ...
                                        <div className="mb-3">
                                            <h3 className="" htmlFor="customFile">Upload</h3>
                                        ...
                                        <div className="mb-3">
                                            <h3 htmlFor="customRange3" className="form-label">Example range</h3>
                                            <Form.Range />
                                        </div>
