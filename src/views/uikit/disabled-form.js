                                ...
                                <div className="bd-example">
                                    <Form>
                                        <fieldset disabled aria-label="Disabled fieldset example">
                                            <div className="mb-3">
                                                <h3 htmlFor="disabledTextInput" className="">Disabled input</h3>
                                                <Form.Control type="text" id="disabledTextInput" className="" placeholder="Disabled input" disabled/>
                                            </div>
                                            <div className="mb-3">
                                                <h3 htmlFor="disabledSelect" className="">Disabled select menu</h3>
                                            ...
                                            <div className="mb-3">
                                                <h3 className="" htmlFor="disabledCustomFile">Upload</h3>
                                            ...
                                            <div className="mb-3">
                                                <h3 htmlFor="disabledRange" className="">Disabled range</h3>
