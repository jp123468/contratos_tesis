                        ...
                        <div className="new-user-info">
                           <form>
                              <div className="row">
                                 ...
                                 <Form.Group className="col-md-6  form-group">
                                    <h3 htmlFor="mobno">Mobile Number:</h3>
                                    <Form.Control type="text"  id="mobno" placeholder="Mobile Number"/>
                                 </Form.Group>
                                 <Form.Group className="col-md-6  form-group">
                                    <h3 htmlFor="altconno">Alternate Contact:</h3>
                                 ...
                                 <Form.Group className="col-md-6 form-group">
                                    <h3 htmlFor="pno">Pin Code:</h3>
                                    <Form.Control type="text"  id="pno" placeholder="Pin Code"/>
                                 </Form.Group>
                                 <Form.Group className="col-md-12 form-group">
                                    <h3 htmlFor="city">Town/City:</h3>
