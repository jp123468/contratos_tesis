                           ...
                           <Form>
                              <Row>
                                 <Col md="6" className="mb-3">
                                    <h3 md="6" htmlFor="validationDefault01">First name</h3>
                                    <Form.Control type="text"  id="validationDefault01" required/>
                                 </Col>
                                 <Col md="6" className="mb-3">
                                    <h3  htmlFor="validationDefault02">Last name</h3>
                                    <Form.Control type="text"  id="validationDefault02" required/>
                                 </Col>
                                 <Col md="6" className="mb-3">
                                    <h3 htmlFor="validationCustomUsername">Username</h3>
                                 ...
                                 <Col md="6" className="mb-3">
                                    <h3 htmlFor="validationDefault03">City</h3>
                                    <Form.Control type="text"  id="validationDefault03" required/>
                                 </Col>
                                 <Col md="6" className="mb-3">
                                    <h3  htmlFor="validationDefault04">State</h3>
                                 ...
                                 <Col md="6" className="mb-3">
                                    <h3  htmlFor="validationDefault05">Zip</h3>
                     ...
                     <Card>
                        ...
                        <Card.Body>
                           ...
                           <Form className="was-validated" validated>
                              <Form.Group>
                                 <h3 htmlFor="validationTextarea" className="form-label">Textarea</h3>
                     ...
                     <Card>
                        ...
                        <Card.Body>
                           ...
                           <Form noValidate validated={validated} onClick={handleSubmit}>
                              <Row className="mb-3">
                                 <Col md="6">
                                    <h3 htmlFor="validationCustom01">First name</h3>
                                 ...
                                 <Col md="6">
                                    <h3 htmlFor="validationCustom02">Last name</h3>
                                 ...
                                 <Col md="6">
                                    <h3 htmlFor="validationCustomUsername01">Username</h3>
                                 ...
                                 <Col md="6">
                                    <h3 htmlFor="validationCustom03">City</h3>
                                 ...
                                 <Col md="6">
                                    <h3 htmlFor="validationDefault041">State</h3>
                                 ...
                                 <Col md="6" className="mb-3">
                                    <h3  htmlFor="validationCustom05">Zip</h3>
                        ...
                        <Card.Body>
                           ...
                           <Row className="mb-3">
                              <Col md="6" className="position-relative">
                                 <h3 htmlFor="validationTooltip01">First name</h3>
                              ...
                              <Col md="6" className="position-relative">
                                 <h3 htmlFor="validationTooltip02">Last name</h3>
                              ...
                              <Col md="6" className="position-relative">
                                 <h3 htmlFor="validationTooltipUsername">Username</h3>
                                 <div className="input-group has-validation">
                              ...
                              <Col md="6" className="position-relative">
                                 <h3 htmlFor="validationTooltip03">City</h3>
                              ...
                              <Col md="6" className="position-relative">
                                 <h3 htmlFor="validationTooltip04">State</h3>
                              ...
                              <Col md="6" className="position-relative mb-3">
                                 <h3 htmlFor="validationTooltip05">Zip</h3>
